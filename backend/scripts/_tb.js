...
for (const raw of process.argv.slice(2)) {
  ...
  for (const m of ms) { const q=m.q; console.log(`  [${m.exam}] ${q.exam_code} #${q.number} | ${q.subject}`); console.log('  Q:', JSON.stringify(q.question).slice(0,120)); console.log('  O:', JSON.stringify(q.options)); console.log('  a:', q.answer) }
}
