...
爬蟲下載任何 PDF 後，**解析前必須先確認類科名稱**：
1. 用 `pdfParse(buf).text` 取前 200 字
2. 確認文字包含預期的考試名稱（如「醫事檢驗師」、「物理治療師」、「醫事放射師」）
3. 若類科名稱不符 → 立即停止、報錯、不寫入 JSON

背景：105年 020系列考試 class code 全面重新洗牌，導致醫檢/物治/放射三科 105020/105100 共 2,879 題互相污染（2026-04-18 發現並清除）。
...
- 醫事檢驗師 105年 第一/二次（105020/105100）：480+480=960 題已移除
  - 原內容為物理治療師題目（頸椎、肩關節等），class code 在 105 年指向不同考試
- 物理治療師 105年 第一/二次（105020/105100）：479+480=959 題已移除
  - 原內容為醫事放射師題目（細胞存活曲線、輻射劑量等）
- 醫事放射師 105年 第一/二次（105020/105100）：480+480=960 題已移除
  - 原內容為醫事檢驗師題目（血紅素、顯微鏡、細菌培養等）
- **三科 2,879 題互相交叉污染，105 年 020 系列 class code 全部重新洗牌**
  - 正確 class code 需瀏覽器查考選部確認後重爬（2026-04-18 清除）
