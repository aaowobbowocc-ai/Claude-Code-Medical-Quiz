...
const LOOKUP_ENTRIES = [
  ...
  // 102030: c=110；103030/103100: c=109（2026-05-17 PDF probe 修正，原 c=107 是臨床心理師）
  lu('102030','基礎醫學','110','0108'), lu('102030','基本護理學與護理行政','110','0601'),
  lu('102030','內外科護理學','110','0602'), lu('102030','產兒科護理學','110','0603'),
  lu('102030','精神科與社區衛生護理學','110','0604'),
  ...['103030','103100'].flatMap(code => [
    lu(code,'基礎醫學','109','0107'), lu(code,'基本護理學與護理行政','109','0501'),
    lu(code,'內外科護理學','109','0502'), lu(code,'產兒科護理學','109','0503'),
    lu(code,'精神科與社區衛生護理學','109','0504'),
  ]),
  ...
  lu('102030','中醫基礎醫學(一)','104','0201'), lu('102030','中醫基礎醫學(二)','104','0202'),
  lu('103030','中醫基礎醫學(一)','103','0201'), lu('103030','中醫基礎醫學(二)','103','0202'),
  ...
  lu('102030','中醫臨床醫學(一)','105','0203'), lu('102030','中醫臨床醫學(二)','105','0204'),
  lu('102030','中醫臨床醫學(三)','105','0205'), lu('102030','中醫臨床醫學(四)','105','0206'),
  // 103030 tcm2: split across two class codes
  lu('103030','中醫臨床醫學(一)','104','0203'), lu('103030','中醫臨床醫學(二)','104','0204'),
  lu('103030','中醫臨床醫學(三)','104','0205'), lu('103030','中醫臨床醫學(四)','104','0206'),
  ...
  // ── DOCTOR2 ──────────────────────────────────────────────────────────────────
  // 030 series (c=102): exam codes 100030, 100140, 101030, 101110, 102030, 102110, 103030, 103100, 104030
  ...['100030','100140','101030','101110','102030','102110','103030','103100','104030'].flatMap(code => [
    lu(code,'醫學(三)','102','0103'),
    lu(code,'醫學(四)','102','0104'),
    lu(code,'醫學(五)','102','0105'),
    lu(code,'醫學(六)','102','0106'),
  ]),
  // 020 series (c=302): exam codes 104090, 105020, 105100
  ...['104090','105020','105100'].flatMap(code => [
    lu(code,'醫學(三)','302','11'),
    lu(code,'醫學(四)','302','22'),
    lu(code,'醫學(五)','302','33'),
