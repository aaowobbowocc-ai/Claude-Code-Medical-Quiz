...
// v79 (2026-09-16): 本輪大規模資料修正，全部需要既有使用者重新下載：
//   - 獸醫 104090 五張卷是藥師「藥物治療學」的題(跨考試污染)，479 題用原卷重建
//   - 藥師一階 106~109 卷一整卷是卷三的複製品，603 題換成真正的藥理學與藥物化學
//   - 牙醫二階 110~115 共 10 場卷別與題號錯位，2,080 題重新對齊
//   - 26 個考試補標 626 題爭議題(官方更正答案)、10 題答案修正、274 題補圖
// v80 (2026-09-16): 物理治療師 106~109 共 42 卷科目標籤兩兩互換(3,360 題),
//   使用者選「骨科」練到的是「概論」的題;另清掉 82 題題組解析損壞(警察/關務英文)
