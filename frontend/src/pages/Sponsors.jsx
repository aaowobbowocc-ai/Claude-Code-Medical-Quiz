  ...
  const inner = (
    <div className="flex items-center gap-3 relative">
      ...
      <div className="flex-1 min-w-0">
        ...
        {sponsor.message && (
          <p className={`italic mt-0.5 truncate text-stone-800 font-medium ${
      ...
      <div className="relative px-4 pt-5 pb-2">
        ...
        <div className="relative max-w-sm mx-auto">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <p className="font-imperial text-[9px] tracking-[0.6em] text-amber-900 font-bold mb-1">
              ─ 共 立 鴻 名 ─
            </p>
            <h1 className="font-imperial font-black text-5xl gold-text leading-none">
              感謝榜
            </h1>
            <p className="font-imperial text-[11px] text-amber-900 font-bold mt-2">
              諸君 · 同立此榜
            </p>
          </div>
        </div>
          ...
          <div className="relative my-6 mx-auto max-w-md">
            <div className="diamond-card">
              <div className="diamond-card-inner py-8 text-center relative z-10">
                ...
                <p className="text-sm text-stone-900 font-semibold mb-5 leading-relaxed font-imperial">
                  凡有心人皆可上榜<br />
                  匿名或具名 一份心意便足
                </p>
                {!IS_NATIVE && (
