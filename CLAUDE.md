...
- 醫師一階 104年第二次（104090 c=301 s=55,66）已補回 160 題
...
| 項目 | 狀況 | 備注 |
|------|------|------|
| 藥師二階 104年 第二次 調劑/藥治 | 130 題已移除，待重爬 | 正確 session/class 未知，需查考選部 |
| 放射師 111年 第二次 器材學 | 69/80 題 | 111100 session URL 曾 302，待重試 |
| 關務特考 108/111/112/113年 法學知識 | 各缺 6-12 題 | 三等/四等分級嵌入 PDF 中段，需專用 parser |
...
| 護理師 102/103年 Q41-80（各科 ~40 題） | 同上，舊系統 PDF 已不可存取 |
