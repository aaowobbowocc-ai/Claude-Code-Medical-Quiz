...
//   audiologist/speech-therapist 105 年起一年一試，只辦第一次
//   speech-therapist 104 第一次 MoEX 從未上線（probed 全 302）
//   audiologist/speech-therapist 100 年第一次為「特考」(special_high)，僅辦第一次
//   social-worker 104 起辦、103 以前未辦
const NOT_HELD = {
  ot: { '110': ['s1'], '111': ['s1'], '112': ['s1'], '113': ['s1'], '114': ['s1'], '115': ['s1'] },
  vet: { '110': ['s1'], '111': ['s1'], '112': ['s1'], '113': ['s1'], '114': ['s1'], '115': ['s1'] },
  audiologist: {
    '105': ['s2'], '106': ['s2'], '107': ['s2'], '108': ['s2'], '109': ['s2'],
    '110': ['s2'], '111': ['s2'], '112': ['s2'], '113': ['s2'], '114': ['s2'], '115': ['s2'],
  },
  'speech-therapist': {
    '104': ['s1'],  // MoEX 無資料
    '105': ['s2'], '106': ['s2'], '107': ['s2'], '108': ['s2'], '109': ['s2'],
