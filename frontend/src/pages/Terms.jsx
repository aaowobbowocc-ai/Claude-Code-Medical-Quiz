      ...
      <div className="flex-1 px-5 py-6">
        <div className="bg-white rounded-2xl shadow-sm p-6 text-sm text-gray-700 leading-relaxed space-y-5">
          ...
          <section>
            ...
            <p>
              「國考知識王」（以下簡稱「本平台」）是一個免費的國家考試題庫練習平台，涵蓋醫事 17 類（醫師、牙醫師、藥師、護理師、中醫師、獸醫師、醫事檢驗師、物理治療師、職能治療師、醫事放射師、營養師、社會工作師、呼吸治療師等）、律師一試、公職 8 類（高考三等、普考、初考、關務、警察、司法特考等）、汽機車駕照筆試，合計 27 類國考，收錄 100-115 年 187,000+ 題考古題，
