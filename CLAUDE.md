...
⚠️ **100年 140 場次（第二次）**：c=103=藥師, c=105=護理師, c=106=中醫師(一+二), c=107=營養師。中醫師(一)/(二) 共用 c=106（s=0501-0502=tcm1, s=0503-0506=tcm2）。中醫師(一) 中醫基礎醫學(二) s=0502 為全圖像 PDF，已用 OCR Vision 補齊（2026-04-19）。
...
| 缺圖題（image-dep）2,627 題 | 已 `incomplete:true` 隱藏（2026-04-19）| `gap_reason: "missing_image_dep"`；待 PDF 圖片抽取 pipeline 救回。受傷最重：放射師 -800、醫師二階 -396、牙醫二階 -287、獸醫 -249、醫檢師 -168 |
